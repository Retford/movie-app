...
const CardMovie = ({ results, params }) => {
  return (
    <main className='max-w-screen grid place-content-center lg:grid-cols-4 2xl:grid-cols-5 tablet:grid-cols-3 grid-cols-2 xl:max-w-screen-2xl xl:m-auto gap-3 p-4 lg:gap-0 lg:p-0'>
